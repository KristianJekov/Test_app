...
def edit_curr_device(driver, version=0):
    ...
    try:
        edit_device_version_button = driver.find_element(By.XPATH, f'{config.EDIT_DEVICE_VERSION}[2]' )
        edit_device_version_button.click()

    except:
        edit_device_version_button = driver.find_element(By.XPATH, f'{config.EDIT_DEVICE_VERSION}[1]')
        edit_device_version_button.click()
