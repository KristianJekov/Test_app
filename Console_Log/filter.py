...
def check_sensor_hub_ver(line, dict):
    check_component_ver(
        line,
        dict,
        "sensorhub: sensorhub_create - Device firmware version:",
        "Sensor Hub",
        -22,
    )
...
def check_batt_ver(line, dict):
    check_component_ver(
        line, dict, "btdevmng: battery - firmware version:", "Battery", -22
    )


def check_remote_ver(line, dict):
    check_component_ver(
        line, dict, "btdevmng: remote - firmware version:", "Remote", -22
    )
