...
EDIT_DEVICE_VERSION = "(//*[name()='svg' and @class='svg-inline--fa fa-pen fa-w-16'])[2]"
...
SAVE_VERSION_BUTTON = "/html/body/div[2]/div[2]/div/mat-dialog-container/app-device-specific-sw-edit/form/div[2]/button[2]"
